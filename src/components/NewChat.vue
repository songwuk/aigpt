          ...
          <nav class="flex h-full flex-1 flex-col space-y-1 p-2">
            ...
            <div class="flex-col flex-1 overflow-y-auto border-b border-white/20 -mr-2">
              <div class="flex flex-col gap-2 text-gray-100 text-sm">
                <a v-for="(item, index) in historyData" :key="index" class="flex py-3 px-3 items-center gap-3 relative rounded-md hover:bg-[#2A2B32] cursor-pointer break-all hover:pr-4 group" @click="pageChat">
                ...
                <div class="absolute top-0 right-0 -mr-12 pt-2 opacity-100">
                  ...
                  <nav class="flex h-full flex-1 flex-col space-y-1 p-2">
                    ...
                    <div class="flex-col flex-1 overflow-y-auto border-b border-white/20">
                      <div class="flex flex-col gap-2 text-gray-100 text-sm">
                        <a v-for="(item, index) in historyData" :key="index" class="flex py-3 px-3 items-center gap-3 relative rounded-md cursor-pointer break-all pr-14 bg-black-800 hover:bg-gray-800 group">
                          <img class="w-17px" :src="NewChat" alt="NewChat">
