      ...
      <div v-else class="flex flex-col text-zinc-200 text-center items-center">
        ...
        <template v-if="createOrSign">
          <div>
            ...
            <button class="bg-zinc-700 px-4 py-2 rounded-lg  w-64 shadow flex items-center justify-center space-x-2 border border-zinc-500 border-opacity-50 hover:brightness-110" @click="login">
