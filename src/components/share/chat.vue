...
<template>
  <main class="bg-gray-50">
    ...
    <div class="pb-24 dark:bg-[#343541] min-h-screen">
      <div v-for="(item, index) in list" :key="index" class="flex flex-col items-center ">
