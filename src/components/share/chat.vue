...
<template>
  <main class="bg-gray-50">
    ...
    <div v-for="(item, index) in list" :key="index" class="flex flex-col items-center pb-24 dark:bg-[#343541] min-h-screen">
    ...
    <!-- <div class="z-10 fixed bottom-5 inset-x-0 mx-auto max-w-fit rounded-lg px-3 py-2 bg-white border border-gray-100 shadow-md flex justify-between space-x-2 items-center">
      <a target="_blank" rel="noopener noreferrer" class="flex space-x-3 items-center justify-center font-medium text-gray-600 px-3 h-14 rounded-md hover:bg-gray-100 active:bg-gray-200 transition-all" href="https://sharegpt.com/"><img alt="ShareGPT logo" srcset="/logo.svg 1x, /logo.svg 2x" src="./Check out this ShareGPT conversation_files/logo.svg" width="20" height="20" decoding="async" data-nimg="1" class="rounded-sm" loading="lazy" style="color:transparent"><p>Shared via ShareGPT</p></a>
      <div class="border-l border-gray-200 h-10 w-1" />
      <button class="p-2 flex flex-col space-y-1 items-center rounded-md w-12 hover:bg-gray-100 active:bg-gray-200 transition-all">
        ...
        </svg><p class="text-center text-gray-600 text-sm">
          Copy
        </p>
      </button>
      <button class=" p-2 flex flex-col space-y-1 items-center rounded-md w-12 hover:bg-gray-100 active:bg-gray-200 transition-all">
      ...
      <div class="cursor-default p-2 flex flex-col space-y-1 items-center rounded-md w-12 hover:bg-gray-100 active:bg-gray-200 transition-all">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4 text-gray-600">
